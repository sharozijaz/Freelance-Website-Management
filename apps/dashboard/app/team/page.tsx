...
export default async function TeamPage() {
  ...
  if (!context) {
    return (
      <DashboardPage title="Team">
        <UnauthorizedState message="Sign in to manage team access." />
      </DashboardPage>
    );
  }
      ...
      {team.canManage ? (
        <Card>
          ...
          <CardContent className="p-4 pt-0">
            <form
              action={`/api/workspaces/${team.organizationId}/invitations`}
          ...
          {team.members.length === 0 ? (
            ...
            <div className="divide-y divide-border">
              {team.members.map((member) => (
                <div
                  className="grid gap-3 py-3 md:grid-cols-[1fr_12rem_16rem] md:items-center"
                  key={member.id}
                >
                  <div>
                  ...
                  {team.canManage ? (
                    ...
                    >
                      ...
                      <Button name="action" size="sm" type="submit" value="role" variant="outline">
                        Save
                      </Button>
                      <Button
                        name="action"
          ...
          {team.pendingInvitations.length === 0 ? (
            ...
            <div className="divide-y divide-border">
              {team.pendingInvitations.map((invitation) => (
                <div
                  className="grid gap-3 py-3 md:grid-cols-[1fr_10rem_auto] md:items-center"
                  key={invitation.id}
                >
                  <div>
